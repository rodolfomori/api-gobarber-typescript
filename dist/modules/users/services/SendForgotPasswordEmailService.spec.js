...
var FakeUsersTokensRepository_1 = __importDefault(require("@modules/users/repositories/fakes/FakeUsersTokensRepository"));
...
describe('SendForgotPasswordEmail', function () {
    ...
    it('should be able to recover the passord using the email', function () { return __awaiter(void 0, void 0, void 0, function () {
        var sendMail;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, sendForgotPasswordEmail.execute({ email: 'johndoe@example.com' })];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, expect(sendMail).toHaveBeenCalled()];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should not be able to recover a non-existing user password', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(sendForgotPasswordEmail.execute({ email: 'johndoe@example.com' })).rejects.toBeInstanceOf(AppError_1.default)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should generate a forgot password token', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, expect(generateToken).toHaveBeenCalledWith(user.id)];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
