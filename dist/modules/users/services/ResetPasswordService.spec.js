...
var resetPassword;
describe('ResetPassordPassword', function () {
    beforeEach(function () {
    ...
    it('should be able to reset the password', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    updatedUser = _a.sent();
                    return [4 /*yield*/, expect(generateHash).toHaveBeenCalledWith('123123')];
                case 5:
                    _a.sent();
                    return [4 /*yield*/, expect(updatedUser === null || updatedUser === void 0 ? void 0 : updatedUser.password).toBe('123123')];
                case 6:
                    _a.sent();
                    return [2 /*return*/];
            }
