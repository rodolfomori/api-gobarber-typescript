...
describe('ShowProfile', function () {
    ...
    it('should be able to show the profile', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    profile = _a.sent();
                    return [4 /*yield*/, expect(profile.name).toBe('John Doe')];
                case 3:
                    _a.sent();
    ...
    it('should not be able to show the profile of non-existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
