...
describe('UpdateUserAvatar', function () {
    ...
    it('should be able update user avatar', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user;
    ...
    it('should not be able to update user avatar to non existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
