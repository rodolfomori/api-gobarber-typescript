...
describe('UpdateProfile', function () {
    ...
    it('should be able to update the profile', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    updatedUser = _a.sent();
                    return [4 /*yield*/, expect(updatedUser.name).toBe('John Trê')];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, expect(updatedUser.email).toBe('johntre@example.com')];
                case 4:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should not be able to change the email to an already used email', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUsersRepository.create({
    ...
    it('should not be able to update the profile with non existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(updateProfile.execute({
                        user_id: 'non-existint-user-id',
                        name: 'John Trê',
                        email: 'johntre@example.com',
                    })).rejects.toBeInstanceOf(AppError_1.default)];
                case 1:
