...
var AppointmenstRepository = /** @class */ (function () {
    function AppointmenstRepository() {
        this.ormRepository = typeorm_1.getRepository(Appointment_1.default);
    }
    AppointmenstRepository.prototype.findByDate = function (date) {
    ...
    AppointmenstRepository.prototype.findAllInMonthFromProvider = function (_a) {
    ...
    AppointmenstRepository.prototype.findAllInDayFromProvider = function (_a) {
    ...
    AppointmenstRepository.prototype.create = function (_a) {
    ...
    return AppointmenstRepository;
}());
exports.default = AppointmenstRepository;
